...
const Projects = () => {
  return (
    ...
    <div className="mt-5 flex flex-col gap-3 text-slate-500">
      <p>
        I've embarked on numerous projects thorough the years, but these are the ones I hold the closest to my heart. Many of them are open-source, so if you come accross something that piques your interest, feel free to explore the codebase and contribute your ideas for further enhancements. Your collaboration is highly valued!
      </p>
    </div>
